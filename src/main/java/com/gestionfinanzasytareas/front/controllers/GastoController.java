...
public class GastoController {
    ...
    private static String INGRESO_URL = "http://localhost:8080/api/gastos";
    
    private final RestTemplate restTemplate;
    
    @Autowired
    public GastoController(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    @GetMapping("/gastos/obtener")
    public ResponseEntity<List<Map<String, Object>>> gastosPorCategorias() {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                List<Map<String, Object>> gastos = (List<Map<String, Object>>) responseMap.get("data");
    ...
    public ResponseEntity<String> crearTarea(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            requestBody.put("monto", request.get("monto"));
            requestBody.put("fecha", fecha);
            requestBody.put("cuenta", new JSONObject().put("id", sessionManager.getIDcuenta()));
            requestBody.put("categoria", new JSONObject().put("id", request.get("categoriaID")));
